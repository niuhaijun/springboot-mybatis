...
public class SysPrivilegeExample {
    ...
    public SysPrivilegeExample sumId() {
        this.sumCol="id";
        return this;
    }

    public SysPrivilegeExample sumPrivilegeName() {
        this.sumCol="privilege_name";
        return this;
    }

    public SysPrivilegeExample sumPrivilegeUrl() {
        this.sumCol="privilege_url";
        return this;
    }
    ...
    public SysPrivilegeExample page(int offset, int limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
